...
const SearchMedicalRecipes = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    router.push(`/searchMedicalRecipes?userAddress=${values.patientAddress}`)
  ...
  return (
    <div className="flex flex-col max-w-4xl mx-auto min-h-screen my-8 gap-y-6">
      <h1 className="text-4xl font-semibold">Welcome {userInfo?.name}</h1>
      <div className="flex flex-col p-4 md:p-8 bg-background shadow-lg rounded-lg gap-y-5 ">
